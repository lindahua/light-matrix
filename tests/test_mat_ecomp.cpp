...
BEGIN_TPACK( mat_ecomp_eq )
	ADD_MN_CASE( mat_ecomp, eq, 0, 0 )
	ADD_MN_CASE( mat_ecomp, eq, 0, 1 )
	ADD_MN_CASE( mat_ecomp, eq, 0, default_n )
	ADD_MN_CASE( mat_ecomp, eq, 1, 0 )
	ADD_MN_CASE( mat_ecomp, eq, 1, 1 )
	ADD_MN_CASE( mat_ecomp, eq, 1, default_n )
	ADD_MN_CASE( mat_ecomp, eq, default_m, 0 )
	ADD_MN_CASE( mat_ecomp, eq, default_m, 1 )
	ADD_MN_CASE( mat_ecomp, eq, default_m, default_n )
END_TPACK

BEGIN_TPACK( mat_ecomp_ne )
	ADD_MN_CASE( mat_ecomp, ne, 0, 0 )
	ADD_MN_CASE( mat_ecomp, ne, 0, 1 )
	ADD_MN_CASE( mat_ecomp, ne, 0, default_n )
	ADD_MN_CASE( mat_ecomp, ne, 1, 0 )
	ADD_MN_CASE( mat_ecomp, ne, 1, 1 )
	ADD_MN_CASE( mat_ecomp, ne, 1, default_n )
	ADD_MN_CASE( mat_ecomp, ne, default_m, 0 )
	ADD_MN_CASE( mat_ecomp, ne, default_m, 1 )
	ADD_MN_CASE( mat_ecomp, ne, default_m, default_n )
END_TPACK

BEGIN_TPACK( mat_ecomp_le )
	ADD_MN_CASE( mat_ecomp, le, 0, 0 )
	ADD_MN_CASE( mat_ecomp, le, 0, 1 )
	ADD_MN_CASE( mat_ecomp, le, 0, default_n )
	ADD_MN_CASE( mat_ecomp, le, 1, 0 )
	ADD_MN_CASE( mat_ecomp, le, 1, 1 )
	ADD_MN_CASE( mat_ecomp, le, 1, default_n )
	ADD_MN_CASE( mat_ecomp, le, default_m, 0 )
	ADD_MN_CASE( mat_ecomp, le, default_m, 1 )
	ADD_MN_CASE( mat_ecomp, le, default_m, default_n )
END_TPACK

BEGIN_TPACK( mat_ecomp_lt )
	ADD_MN_CASE( mat_ecomp, lt, 0, 0 )
	ADD_MN_CASE( mat_ecomp, lt, 0, 1 )
	ADD_MN_CASE( mat_ecomp, lt, 0, default_n )
	ADD_MN_CASE( mat_ecomp, lt, 1, 0 )
	ADD_MN_CASE( mat_ecomp, lt, 1, 1 )
	ADD_MN_CASE( mat_ecomp, lt, 1, default_n )
	ADD_MN_CASE( mat_ecomp, lt, default_m, 0 )
	ADD_MN_CASE( mat_ecomp, lt, default_m, 1 )
	ADD_MN_CASE( mat_ecomp, lt, default_m, default_n )
END_TPACK

BEGIN_TPACK( mat_ecomp_ge )
	ADD_MN_CASE( mat_ecomp, ge, 0, 0 )
	ADD_MN_CASE( mat_ecomp, ge, 0, 1 )
	ADD_MN_CASE( mat_ecomp, ge, 0, default_n )
	ADD_MN_CASE( mat_ecomp, ge, 1, 0 )
	ADD_MN_CASE( mat_ecomp, ge, 1, 1 )
	ADD_MN_CASE( mat_ecomp, ge, 1, default_n )
	ADD_MN_CASE( mat_ecomp, ge, default_m, 0 )
	ADD_MN_CASE( mat_ecomp, ge, default_m, 1 )
	ADD_MN_CASE( mat_ecomp, ge, default_m, default_n )
END_TPACK

BEGIN_TPACK( mat_ecomp_gt )
	ADD_MN_CASE( mat_ecomp, gt, 0, 0 )
	ADD_MN_CASE( mat_ecomp, gt, 0, 1 )
	ADD_MN_CASE( mat_ecomp, gt, 0, default_n )
	ADD_MN_CASE( mat_ecomp, gt, 1, 0 )
	ADD_MN_CASE( mat_ecomp, gt, 1, 1 )
	ADD_MN_CASE( mat_ecomp, gt, 1, default_n )
	ADD_MN_CASE( mat_ecomp, gt, default_m, 0 )
	ADD_MN_CASE( mat_ecomp, gt, default_m, 1 )
	ADD_MN_CASE( mat_ecomp, gt, default_m, default_n )
END_TPACK
