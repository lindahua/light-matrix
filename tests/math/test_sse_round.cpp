...
using lmat::math::sse_f32pk;
using lmat::math::sse_f64pk;
...
using lmat::math::internal::floor_sse2;
using lmat::math::internal::ceil_sse2;
using lmat::math::internal::trunc_sse2;
using lmat::math::internal::round_sse2;
