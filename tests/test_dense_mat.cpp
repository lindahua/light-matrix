...
template class lmat::dense_matrix<double, DynamicDim, DynamicDim>;
template class lmat::dense_matrix<double, DynamicDim, 4>;
...
BEGIN_TPACK( dense_mat_constructs )
	ADD_MN_CASE( dense_mat, constructs, 0, 0 )
	ADD_MN_CASE( dense_mat, constructs, 0, 1 )
	ADD_MN_CASE( dense_mat, constructs, 0, 4 )
	ADD_MN_CASE( dense_mat, constructs, 1, 0 )
	ADD_MN_CASE( dense_mat, constructs, 1, 1 )
	ADD_MN_CASE( dense_mat, constructs, 1, 4 )
	ADD_MN_CASE( dense_mat, constructs, 3, 0 )
	ADD_MN_CASE( dense_mat, constructs, 3, 1 )
	ADD_MN_CASE( dense_mat, constructs, 3, 4 )
END_TPACK

BEGIN_TPACK( dense_mat_generates )
	ADD_MN_CASE( dense_mat, generates, 0, 0 )
	ADD_MN_CASE( dense_mat, generates, 0, 1 )
	ADD_MN_CASE( dense_mat, generates, 0, 4 )
	ADD_MN_CASE( dense_mat, generates, 1, 0 )
	ADD_MN_CASE( dense_mat, generates, 1, 1 )
	ADD_MN_CASE( dense_mat, generates, 1, 4 )
	ADD_MN_CASE( dense_mat, generates, 3, 0 )
	ADD_MN_CASE( dense_mat, generates, 3, 1 )
	ADD_MN_CASE( dense_mat, generates, 3, 4 )
END_TPACK

BEGIN_TPACK( dense_mat_copycon )
	ADD_MN_CASE( dense_mat, copy_constructs, 0, 0 )
	ADD_MN_CASE( dense_mat, copy_constructs, 0, 1 )
	ADD_MN_CASE( dense_mat, copy_constructs, 0, 4 )
	ADD_MN_CASE( dense_mat, copy_constructs, 1, 0 )
	ADD_MN_CASE( dense_mat, copy_constructs, 1, 1 )
	ADD_MN_CASE( dense_mat, copy_constructs, 1, 4 )
	ADD_MN_CASE( dense_mat, copy_constructs, 3, 0 )
	ADD_MN_CASE( dense_mat, copy_constructs, 3, 1 )
	ADD_MN_CASE( dense_mat, copy_constructs, 3, 4 )
END_TPACK

BEGIN_TPACK( dense_mat_access )
	ADD_MN_CASE( dense_mat, access, 0, 0 )
	ADD_MN_CASE( dense_mat, access, 0, 1 )
	ADD_MN_CASE( dense_mat, access, 0, 4 )
	ADD_MN_CASE( dense_mat, access, 1, 0 )
	ADD_MN_CASE( dense_mat, access, 1, 1 )
	ADD_MN_CASE( dense_mat, access, 1, 4 )
	ADD_MN_CASE( dense_mat, access, 3, 0 )
	ADD_MN_CASE( dense_mat, access, 3, 1 )
	ADD_MN_CASE( dense_mat, access, 3, 4 )
END_TPACK

BEGIN_TPACK( dense_mat_resize )
	ADD_MN_CASE( dense_mat, resize, 0, 0 )
	ADD_MN_CASE( dense_mat, resize, 0, 1 )
	ADD_MN_CASE( dense_mat, resize, 0, 4 )
	ADD_MN_CASE( dense_mat, resize, 1, 0 )
	ADD_MN_CASE( dense_mat, resize, 1, 1 )
	ADD_MN_CASE( dense_mat, resize, 1, 4 )
	ADD_MN_CASE( dense_mat, resize, 3, 0 )
	ADD_MN_CASE( dense_mat, resize, 3, 1 )
	ADD_MN_CASE( dense_mat, resize, 3, 4 )
END_TPACK

BEGIN_TPACK( dense_mat_assign )
	ADD_MN_CASE( dense_mat, assign, 0, 0 )
	ADD_MN_CASE( dense_mat, assign, 0, 1 )
	ADD_MN_CASE( dense_mat, assign, 0, 4 )
	ADD_MN_CASE( dense_mat, assign, 1, 0 )
	ADD_MN_CASE( dense_mat, assign, 1, 1 )
	ADD_MN_CASE( dense_mat, assign, 1, 4 )
	ADD_MN_CASE( dense_mat, assign, 3, 0 )
	ADD_MN_CASE( dense_mat, assign, 3, 1 )
	ADD_MN_CASE( dense_mat, assign, 3, 4 )
END_TPACK

BEGIN_TPACK( dense_mat_assign_gen )
	ADD_MN_CASE( dense_mat, assign_gen, 0, 0 )
	ADD_MN_CASE( dense_mat, assign_gen, 0, 1 )
	ADD_MN_CASE( dense_mat, assign_gen, 0, 4 )
	ADD_MN_CASE( dense_mat, assign_gen, 1, 0 )
	ADD_MN_CASE( dense_mat, assign_gen, 1, 1 )
	ADD_MN_CASE( dense_mat, assign_gen, 1, 4 )
	ADD_MN_CASE( dense_mat, assign_gen, 3, 0 )
	ADD_MN_CASE( dense_mat, assign_gen, 3, 1 )
	ADD_MN_CASE( dense_mat, assign_gen, 3, 4 )
END_TPACK

BEGIN_TPACK( dense_mat_swap )
	ADD_MN_CASE( dense_mat, swap, 0, 0 )
	ADD_MN_CASE( dense_mat, swap, 0, 1 )
	ADD_MN_CASE( dense_mat, swap, 0, 4 )
	ADD_MN_CASE( dense_mat, swap, 1, 0 )
	ADD_MN_CASE( dense_mat, swap, 1, 1 )
	ADD_MN_CASE( dense_mat, swap, 1, 4 )
	ADD_MN_CASE( dense_mat, swap, 3, 0 )
	ADD_MN_CASE( dense_mat, swap, 3, 1 )
	ADD_MN_CASE( dense_mat, swap, 3, 4 )
END_TPACK
