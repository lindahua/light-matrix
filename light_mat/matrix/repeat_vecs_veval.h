		...
		typedef typename
				if_c<N == 1,
					...
					if_c<M == 1,
						...
						cached_linear_evaluator<repeat_col_expr<Col, N> >
					>::type
				>::type type;
	};
		...
		typedef typename
				if_c<M == 1,
					...
					if_c<N == 1,
						...
						cached_linear_evaluator<repeat_row_expr<Row, M> >
					>::type
				>::type type;
	};
		...
		typedef typename
				if_c<M == 1,
					...
					if_c<N == 1,
						...
						reprow_percol_evaluator<repeat_row_expr<Row, M> >
					>::type
				>::type type;
	};
